...
(define TRACK
  '((detection-block
    ;(name clockwise-in      clockwise-out    )
     ...
     (1-6  (switch  . S-5  ) (dblock  . 1-7  )) ;(1-6  (switchX . S-5-6) (dblock  . 1-7  ))
     (1-7  (dblock  . 1-6  ) (switch  . S-28 ))
     (1-8  (switch  . S-25 ) NIL              )
     (2-1  (switch  . S-1  ) NIL              )
     (2-2  NIL               (switch  . S-3  )) ;(2-2  NIL               (switch3 . S-2-3))
     (2-3  (switch  . S-12 ) (switch  . S-6  )) ;(2-3  (switch  . S-12 ) (switchX . S-5-6))
    ...
    ;(name clockwise-in      clockwise-out    )
     ...
     (U-6  (switch  . S-2  ) (switch  . S-1  )) ;(U-6  (switch3 . S-2-3) (switch  . S-1  ))
     (U-7  NIL               (switch  . S-16 ))
     )
    (switch
    ;(name in                out1              out2             )
     (S-1  (segment . U-6  ) (dblock  . 2-1  ) (switch  . S-25 ))
     (S-2  (segment . U-6  ) (switch  . S-7  ) (switch  . S-3  )) ;DELETE
     (S-3  (switch  . S-2  ) (dblock  . 2-2  ) (switch  . S-8  )) ;DELETE
     (S-4  (switch  . S-8  ) (dblock  . 2-6  ) (dblock  . 2-7  ))
     (S-5  (switch  . S-6  ) (dblock  . 1-6  ) (switch  . S-7  )) ;DELETE
     (S-6  (switch  . S-5  ) (dblock  . 2-3  ) (switch  . S-20 )) ;DELETE
     (S-7  (switch  . S-5  ) (segment . U-5  ) (switch  . S-2  )) ;(S-7  (switchX . S-5-6) (segment . U-5  ) (switch  . S-2-3))
     (S-8  (switch  . S-3  ) (dblock  . 2-5  ) (switch  . S-4  )) ;(S-8  (switch3 . S-2-3) (dblock  . 2-5  ) (switch  . S-4  ))
     ...
     (S-20 (dblock  . 2-4  ) (dblock  . 1-5  ) (switch  . S-6  )) ;(S-20 (dblock  . 2-4  ) (dblock  . 1-5  ) (switchX . S-5-6))
    ...
    (switch*
     ...
     ;(name  s1  s2  cl-in1         cl-in2          cl-out1        cl-out2       )
      (S-5-6 S-5 S-6 (dblock . 2-3) (switch . S-20) (dblock . 1-6) (switch . S-7))
      )
     )
    (crossing
    ;(name (segment-list))
